...
| 017 | [ADR-017-multi-currency-portfolio-base-rollup.md](./ADR-017-multi-currency-portfolio-base-rollup.md) | Portfolio-base rollup (Phase 2) — `vf_portfolio_meta.baseCurrency`, aggregation-site FX projection, `computeSecurityCostInBase`, `*Base` wire fields, base-primary UI in aggregated contexts | accepted | 2026-05-17 |
| 018 | [ADR-018-multi-currency-phase3-per-lot-fx.md](./ADR-018-multi-currency-phase3-per-lot-fx.md) | Multi-Currency Phase 3 — Per-Lot FX, Decomposition, Forex View | accepted | 2026-05-20 |
| 019 | [ADR-019-stock-splits-destructive-at-write-time.md](./ADR-019-stock-splits-destructive-at-write-time.md) | Stock splits rewrite shares + historical quotes at write time; stored events are markers only; engine's compute-time split model deleted | accepted | 2026-08-02 |
