...
i18n
  ...
  .init({
    ...
    fallbackLng: 'en',
    defaultNS: 'common',
    ns: ['common', 'navigation', 'securities', 'transactions', 'accounts', 'performance', 'reports', 'settings', 'errors', 'dashboard', 'investments', 'csv-import', 'watchlists', 'welcome', 'switcher', 'portfolioSettings'],
    detection: {
