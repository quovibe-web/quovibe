...
//
// Save handler routes through useGuardedSubmit + mutateAsync (frontend.md
// "Save-button re-entry guard"): the synchronous re-entry guard prevents
// rapid double-clicks from firing two POST /api/portfolios.
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px]">
        ...
        <PortfolioSetupForm
          ...
          isSubmitting={inFlight || create.isPending}
