...
function createTestDb() {
  ...
  sqlite.exec(`
    ...
    CREATE TABLE latest_price (security TEXT PRIMARY KEY, tstamp TEXT, value INTEGER NOT NULL);
    CREATE TABLE price (security TEXT, tstamp TEXT NOT NULL, value INTEGER NOT NULL, PRIMARY KEY (security, tstamp));
