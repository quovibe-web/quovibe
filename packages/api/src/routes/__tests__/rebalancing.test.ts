...
function createTestDb() {
  ...
  sqlite.exec(`INSERT INTO price VALUES ('sec-A','2026-03-17',5000000000,NULL,NULL,NULL)`);
  sqlite.exec(`INSERT INTO price VALUES ('sec-B','2026-03-17',10000000000,NULL,NULL,NULL)`);
