...
// .strict(): silent strip of unknown keys is a footgun on a write endpoint —
// fields belonging to a sibling route used to silently no-op. Strict mode
// surfaces the divergence as 400 ZodError → "Validation error".
